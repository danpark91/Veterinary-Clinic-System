...
void addAppointment(struct Appointment* apptm, int maxAppointment, struct Patient* patients, int maxPatient);

// Remove an appointment record from the appointment array
void removeAppointment(struct Appointment* apptm, int maxAppointment, struct Patient* patients, int maxPatient);
...
// Compare patients' data
int compareData(struct Appointment* a, struct Appointment* b);
